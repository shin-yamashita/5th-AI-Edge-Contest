...
write_checkpoint -force $outputDir/post_route2
report_timing_summary -file $outputDir/post_route2_timing_summary.rpt
report_timing -sort_by group -max_paths 100 -path_type summary -file $outputDir/post_route2_timing.rpt
report_clock_utilization -file $outputDir/post2_clock_util.rpt
report_utilization -file $outputDir/post_route2_util.rpt
report_utilization -hierarchical -file $outputDir/post_route2_area.rpt
report_power -file $outputDir/post_route2_power.rpt
