...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set RXD_0 [ create_bd_port -dir O RXD_0 ]
  set TXD_0 [ create_bd_port -dir I TXD_0 ]
  set fp_0 [ create_bd_port -dir O -from 4 -to 0 fp_0 ]
  set pout_0 [ create_bd_port -dir O -from 7 -to 0 pout_0 ]
  ...
  # Create instance: tfacc_cpu_v1_0_0, and set properties
  set block_name tfacc_cpu_v1_0
  set block_cell_name tfacc_cpu_v1_0_0
  if { [catch {set tfacc_cpu_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tfacc_cpu_v1_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: tfacc_memif_0, and set properties
  set block_name tfacc_memif
  set block_cell_name tfacc_memif_0
  if { [catch {set tfacc_memif_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tfacc_memif_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins tfacc_cpu_v1_0_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net tfacc_memif_0_M00_AXI [get_bd_intf_pins smartconnect_0/S00_AXI] [get_bd_intf_pins tfacc_memif_0/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net TXD_0_1 [get_bd_ports TXD_0] [get_bd_pins tfacc_cpu_v1_0_0/TXD]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins tfacc_cpu_v1_0_0/s00_axi_aresetn] [get_bd_pins tfacc_memif_0/M00_AXI_ARESETN]
  connect_bd_net -net tfacc_cpu_v1_0_0_RXD [get_bd_ports RXD_0] [get_bd_pins tfacc_cpu_v1_0_0/RXD]
  connect_bd_net -net tfacc_cpu_v1_0_0_adr [get_bd_pins tfacc_cpu_v1_0_0/adr] [get_bd_pins tfacc_memif_0/adr]
  connect_bd_net -net tfacc_cpu_v1_0_0_dw [get_bd_pins tfacc_cpu_v1_0_0/dw] [get_bd_pins tfacc_memif_0/dw]
  connect_bd_net -net tfacc_cpu_v1_0_0_pout [get_bd_ports pout_0] [get_bd_pins tfacc_cpu_v1_0_0/pout]
  connect_bd_net -net tfacc_cpu_v1_0_0_re [get_bd_pins tfacc_cpu_v1_0_0/re] [get_bd_pins tfacc_memif_0/re]
  connect_bd_net -net tfacc_cpu_v1_0_0_we [get_bd_pins tfacc_cpu_v1_0_0/we] [get_bd_pins tfacc_memif_0/we]
  connect_bd_net -net tfacc_cpu_v1_0_0_xsrrst [get_bd_pins tfacc_cpu_v1_0_0/xsrrst] [get_bd_pins tfacc_memif_0/xreset]
  connect_bd_net -net tfacc_memif_0_dr [get_bd_pins tfacc_cpu_v1_0_0/dr] [get_bd_pins tfacc_memif_0/dr]
  connect_bd_net -net tfacc_memif_0_fp [get_bd_ports fp_0] [get_bd_pins tfacc_memif_0/fp]
  connect_bd_net -net tfacc_memif_0_rdy [get_bd_pins tfacc_cpu_v1_0_0/rdy] [get_bd_pins tfacc_memif_0/rdy]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins tfacc_cpu_v1_0_0/s00_axi_aclk] [get_bd_pins tfacc_memif_0/M00_AXI_ACLK] [get_bd_pins tfacc_memif_0/cclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces tfacc_memif_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces tfacc_memif_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tfacc_cpu_v1_0_0/s00_axi/reg0] SEG_tfacc_cpu_v1_0_0_reg0
